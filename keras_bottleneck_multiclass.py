...
test_data_dir = '/media/mingrui/DATA/datasets/201801-IDH-jpeg-test'
...
def predict():
    ...
    image_path = '/media/mingrui/DATA/datasets/201801-IDH-jpeg-test/ADC/4481.jpeg'
...
if __name__ == '__main__':
    print('keras bottlenet multiclass')
